...
| 41 | TANKING AND WATERPROOFING | DWG.HSP.ARC.CB.B01.10.001 (Facade set out plans), DWG.HSP.ARC.CC.ELE.00.001 (Facade Elevations), DWG.HSP.ARC.CJ.DET.01.001 (Facade Schedule - Windows) |
