...
|---|------------------------------------------|------|
| 1 | ![Audit_PushITMain]({{ site.baseurl }}\assets\Pushit\Audit_PushITMain.png){:class="img-responsive"}{: height="300px" width="500px"} | In the Push iT interface press the <Audit> button as highlighted below. |
| 2 | ![Audit_PushITSaveTextFile]({{ site.baseurl }}\assets\Pushit\Audit_PushITSaveTextFile.png){:class="img-responsive"}{: height="199px" width="454px"} | Push it will analyse the model and will offer to save a text file if it found any inconsistencies |
| 3 | ![Audit_PushITSaveTextFileAsDialogue]({{ site.baseurl }}\assets\Pushit\Audit_PushITSaveTextFileAsDialogue.png){:class="img-responsive"}{: height="380px" width="640px"} | Select a location where to save the audit text file to. |
| 4 | ![Audit_ExcelOpenTextFile]({{ site.baseurl }}\assets\Pushit\Audit_ExcelOpenTextFile.png){:class="img-responsive"}{: height="390px" width="640px"} | In Excel open the text file via File Open Dialogue. (Make sure the file filter is to 'All files' or 'Text Files') |
| 5 | ![Audit_ExcelImportDelimited]({{ site.baseurl }}\assets\Pushit\Audit_ExcelImportDelimited.png){:class="img-responsive"}{: height="434px" width="579px"} | When opening a text file, Excel will want to know some bits of information about it. In the first window select 'Delimited' |
| 6 | ![Audit_ExcelImportDelimitedTab]({{ site.baseurl }}\assets\Pushit\Audit_ExcelImportDelimitedTab.png){:class="img-responsive"}{: height="434px" width="579px"} | In the following window select the delimeter type : 'Tab' and press 'Finish' |
| 7 | ![Audit_Excel_ApplyFilter]({{ site.baseurl }}\assets\Pushit\Audit_Excel_ApplyFilter.png){:class="img-responsive"}{: height="411px" width="640px"} | Once Excel has imported the file press the little triangle top left corner to select all cells. With all cells selected apply a filter (under 'Sort & Filter') |
