...
|--------------|---------------|
| 00 | COVER SHEETS / LEGEND |
| 01 | INTRODUCTORY I.E. LOCATION PLANS, SITE PLANS EXISTING AND PROPOSED | 
| 10 | GENERAL ARRANGEMENT OR OVERALL DRAWING - 1:200 (AT CAR PARK) 1:500 OR BIGGER AT HOSPITAL TOWER|
| 11 | GENERAL ARRANGEMENT DRAWING - 1:200 AT HOSPITAL TOWER |
| 14 | STAGING DRAWINGS |
...
| 42 | ROOFING COMBINED |
| 43 | FACADE, EXTERNAL WALLS AND CLADDING |
| 44 | SPARE |
...
| K | DRAWN SCHEDULES |
| L | AREA PLAN AND ANALYSIS DIAGRAMS I.E. FIRE COMPARTMENT|
| M | MODEL |
| P | PRESENTATION |
| R | REPORT |
| S | SKETCH |
