...
![Typical Door Type Elevations]({{ site.baseurl }}/assets/Doors/TypicalDoorElevation.svg){:class="img-responsive"}{: height="800px" width="1200px"}

### Typical Door Frame Details

![Typical Door Frame Details]({{ site.baseurl }}/assets/Doors/TypicalDoorFrameDetails.svg){:class="img-responsive"}{: height="400px" width="600px"}

### Typical Door Jamb Details

* Dry Wall
![Typical Door Jamb Detail_Dry Wall]({{ site.baseurl }}/assets/Doors/TypicalDoorDryWallJambDetail.svg){:class="img-responsive"}{: height="400px" width="600px"}
